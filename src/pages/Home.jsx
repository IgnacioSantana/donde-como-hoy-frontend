  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 text-center bg-white text-gray-800">
      ...
      <div className="flex flex-col sm:flex-row justify-center gap-4 w-full max-w-xs sm:max-w-none">
        <Link
          to="/login"
          className="w-full sm:w-auto text-center bg-black text-white px-6 py-3 rounded-full font-semibold hover:opacity-80 transition"
        >
          Iniciar sesión
        </Link>
        <Link
          to="/signup"
          className="w-full sm:w-auto text-center border border-black text-black px-6 py-3 rounded-full font-semibold hover:bg-gray-100 transition"
        >
